#
# Don't edit, this file is generated by FPCMake Version 2.0.0 [2010/10/12]
#
default: all
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_UNITDIR+=dataform $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET) $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET)/$(LCL_PLATFORM) $(CORE_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(DCPCRYPT_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(LNET_PATH)/lazaruspackage/lib/$(CPU_TARGET)-$(OS_TARGET) .
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_UNITDIR+=dataform $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET) $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET)/$(LCL_PLATFORM) $(CORE_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(DCPCRYPT_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(LNET_PATH)/lazaruspackage/lib/$(CPU_TARGET)-$(OS_TARGET) .
endif

...
override PACKAGE_NAME=epidataentryclient
override PACKAGE_VERSION=0.1.1.0
include Makefile.rc
...
ifeq ($(FULL_TARGET),i386-linux)
override CLEAN_FILES+=$(wildcard $(COMPILER_UNITTARGETDIR)/*$(OEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*$(PPUEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*$(RSTEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*.lfm) $(wildcard $(COMPILER_UNITTARGETDIR)/*.res) $(wildcard $(COMPILER_UNITTARGETDIR)/*.or) $(wildcard ./settings/*$(OEXT)) $(wildcard ./settings/*$(PPUEXT)) $(wildcard ./dataform/*$(OEXT)) $(wildcard ./dataform/*$(PPUEXT)) $(wildcard ./search/*$(OEXT)) $(wildcard ./search/*$(PPUEXT)) $(wildcard *$(OEXT)) $(wildcard *$(PPUEXT)) $(wildcard *$(RSTEXT))
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override CLEAN_FILES+=$(wildcard $(COMPILER_UNITTARGETDIR)/*$(OEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*$(PPUEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*$(RSTEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*.lfm) $(wildcard $(COMPILER_UNITTARGETDIR)/*.res) $(wildcard $(COMPILER_UNITTARGETDIR)/*.or) $(wildcard ./settings/*$(OEXT)) $(wildcard ./settings/*$(PPUEXT)) $(wildcard ./dataform/*$(OEXT)) $(wildcard ./dataform/*$(PPUEXT)) $(wildcard ./search/*$(OEXT)) $(wildcard ./search/*$(PPUEXT)) $(wildcard *$(OEXT)) $(wildcard *$(PPUEXT)) $(wildcard *$(RSTEXT))
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_OPTIONS+=-l -dLCL -dLCL$(LCL_PLATFORM) -MObjFPC -Schi -dEPI_SHOWREVISION
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_OPTIONS+=-l -dLCL -dLCL$(LCL_PLATFORM) -MObjFPC -Schi -dEPI_SHOWREVISION
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_UNITDIR+=dataform settings search $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET) $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET)/$(LCL_PLATFORM) $(CORE_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(DCPCRYPT_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(LNET_PATH)/lazaruspackage/lib/$(CPU_TARGET)-$(OS_TARGET) .
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_UNITDIR+=dataform settings search $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET) $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET)/$(LCL_PLATFORM) $(CORE_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(DCPCRYPT_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(LNET_PATH)/lazaruspackage/lib/$(CPU_TARGET)-$(OS_TARGET) .
endif
